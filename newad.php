	...
	if (isset($_SESSION['user'])) {
		...
		if ($_SERVER['REQUEST_METHOD'] == 'POST') {
			...
			if (empty($formErrors)) {
				...
				move_uploaded_file($avatarTmp, "admin\uploads\avatars\item\\" . $avatar);
				...
				$stmt = $con->prepare("INSERT INTO 
					...
					items(Name, Description, Price, Country_Made, Status, tel, Add_Date, Cat_ID, Member_ID, avatar, tags)

					VALUES(:zname, :zdesc, :zprice, :zcountry, :zstatus, :ztel, now(), :zcat, :zmember, :zavatar, :ztags)");
